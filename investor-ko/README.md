# Oysterlab 투자자 브리프 한국어 버전

Purpose: `/investor/` 영문 투자자 브리프의 한국어 버전.

Source strategy files:

- `art-company/strategy_art_service.md`
- `art-company/audience_collection_strategy.md`
- `art-company/README.md`
- `art-company/seeds/contemporary/13_online_platforms_service_patterns.md`
- `content/studio_audience.json`
- `docs/art-service/report-data.json`

Published path:

- `https://oysterlab.github.io/investor-ko/`
- English version: `https://oysterlab.github.io/investor/`
