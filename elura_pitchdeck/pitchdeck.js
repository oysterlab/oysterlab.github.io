const slides = [
  ...
  ["11-market-expansion.png", "Market & Expansion", "Wall art is the first transaction. Personalization expands across the home."],
  ["12-business-model.png", "Business Model", "The direction earns trust. The physical product earns revenue."],
  ["13-validation.png", "Validation", "The system runs. Demand is not yet proven."],
  ["14-go-to-market.png", "Go to Market", "Focus first. Scale only after the signal is qualified."],
