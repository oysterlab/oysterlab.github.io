const slides = [
  ...
  ["04-insight.png", "Insight", "More inspiration does not create a decision."],
  ...
  ["09-initial-customer-hypothesis.png", "Initial Customer Hypothesis", "Start with the moment, not a demographic."],
  ["10-market-and-wedge.png", "Market & Wedge", "A large existing market with one high-intent moment to enter."],
  ["11-business-model.png", "Business Model", "The direction earns trust. The physical product earns revenue."],
  ["12-validation.png", "Validation", "The system runs. Demand is not yet proven."],
  ["13-go-to-market.png", "Go to Market", "Focus first. Scale only after the signal is qualified."],
  ["14-competition.png", "Competition", "The market forces a trade-off. ELURA removes it."],
  ["15-defensibility.png", "Defensibility", "Today: curation and workflow. Later: outcome data."],
  ["16-roadmap.png", "Roadmap", "From concierge proof to a compounding product."],
  ["17-founder-current-ask.png", "Founder & Current Ask", "One founder built the full loop. The next constraint is paid proof."],
  ["18-closing.png", "Closing", "The future of home personalization starts with the person."]
